...
> Dòng log: `{"timestamp": "2026-08-10T17:15:00.000Z", "event": "chat_completed", "client_id": "sv-test", "prompt_tokens": 15, "completion_tokens": 20, "usd_cost": 0.005}`
> Hai việc làm được: 
...
> Lỗi gặp phải: Connection Refused từ Redis. Khi app chạy trên Render, các API `/chat` hoặc `/readyz` báo lỗi 503 và log in ra `ConnectionError`. 
